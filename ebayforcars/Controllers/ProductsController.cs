...
namespace ebayforcars.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [Authorize]
        public ActionResult Create([Bind(Include = "Product_ID,productName,img,price,description")] Product product,HttpPostedFileBase imagefile)
        {
            if (ModelState.IsValid)
            {
                Image img = ImageUtil.Uploadimages(db, imagefile);
                if (img == null)
                {
